...
export const Auth: React.FC<{
	...
	monitorUserChanges?:
		| null
		| ((user: RBAuthUserModelWithRole<RBAuthBaseRoles> | null) => void);
}> = ({
	children,
	authApi,
	routes,
	...
	const [user, setUser] =
		React.useState<RBAuthUserModelWithRole<RBAuthBaseRoles> | null>(null);

	const logic = new BaseAuthApiWrapper(
		setReloading,
		setUser,
		authApi,
		onAuthExpired,
	...
	const contextVal: RBAuthContextType = {
		...
		logic,
		routes: {
			private: routes?.private || "/private",
